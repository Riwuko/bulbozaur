...
import '../../data/remote_data_source/fake_temperature_local_data_source_impl.dart'
    as _i7;
import '../../data/repositories/click_counter_repository_impl.dart' as _i21;
...
import '../../domain/use_case/example_feature/save_click_counter_usecase.dart'
    as _i24;
import '../../domain/use_case/getAllHouses.dart' as _i13;
import '../../domain/use_case/getMeasurements.dart' as _i11;
import '../../domain/use_case/getSchedule.dart' as _i12;
import '../../domain/use_case/loginUseCase.dart' as _i3;
import '../../domain/use_case/saveSchedule.dart' as _i4;
import '../../presentation/choose_home/cubit/choose_home_cubit.dart' as _i19;
import '../../presentation/create_schedule/cubit/create_schedule_cubit.dart'
    as _i22;
import '../../presentation/example_feature/cubit/home_cubit.dart' as _i25;
import '../../presentation/login/cubit/login_cubit.dart' as _i14;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i11.GetMeasurements>(() => _i11.GetMeasurements());
  gh.factory<_i12.GetSchedule>(() => _i12.GetSchedule());
  gh.factory<_i13.GetTheHouses>(() => _i13.GetTheHouses());
  gh.factory<_i14.LoginCubit>(
      () => _i14.LoginCubit(get<_i3.CheckIfLoginIsGood>()));
  gh.factory<_i15.SecureStorage>(
      () => _i16.SecureStorageImpl(get<_i17.FlutterSecureStorage>()));
  gh.factory<_i18.SingleHomeCubit>(() => _i18.SingleHomeCubit(
      get<_i10.GetAllAboutHouse>(),
      get<_i12.GetSchedule>(),
      get<_i11.GetMeasurements>()));
  gh.factory<_i19.ChooseHomeCubit>(
      () => _i19.ChooseHomeCubit(get<_i13.GetTheHouses>()));
  gh.factory<_i20.ClickCounterLocalDataSource>(
      () => _i20.ClickCounterLocalDataSourceImpl(get<_i5.DatabaseClient>()));
  gh.factory<_i21.ClickCounterRepository>(() =>
      _i21.ClickCounterRepositoryImpl(get<_i20.ClickCounterLocalDataSource>()));
  gh.factory<_i22.CreateScheduleCubit>(() => _i22.CreateScheduleCubit(
      get<_i10.GetAllAboutHouse>(), get<_i4.CreateSchedule>()));
  gh.factory<_i23.GetClickCounterUseCase>(
      () => _i23.GetClickCounterUseCase(get<_i21.ClickCounterRepository>()));
  gh.factory<_i24.SaveClickCounterUseCase>(
      () => _i24.SaveClickCounterUseCase(get<_i21.ClickCounterRepository>()));
  gh.factory<_i25.HomeCubit>(() => _i25.HomeCubit(
      get<_i23.GetClickCounterUseCase>(),
      get<_i24.SaveClickCounterUseCase>(),
